<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <div>
        <input id="interest-tutorials" name="interest" type="checkbox" values="tutorials" v-model="interest"/>
        <label for="interest-tutorials">Tutorials</label>
      </div>
      <div>
        <input id="interest-nothing" name="interest" type="checkbox" values="nothing" v-model="interest"/>
